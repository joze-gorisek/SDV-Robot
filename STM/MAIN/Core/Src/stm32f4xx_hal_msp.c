...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI2)
  {
    ...
    PB10    ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = SPI2_MOSI_MRF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_SPI2;
    HAL_GPIO_Init(SPI2_MOSI_MRF_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB10    ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, SPI2_MOSI_MRF_Pin|SPI2_MISO_MRF_Pin);

    HAL_GPIO_DeInit(SPI2_SCK_MRF_GPIO_Port, SPI2_SCK_MRF_Pin);
