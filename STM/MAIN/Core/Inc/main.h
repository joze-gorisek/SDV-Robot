...
#define SPI2_MOSI_MRF_Pin GPIO_PIN_1
#define SPI2_MOSI_MRF_GPIO_Port GPIOC
#define SPI2_MISO_MRF_Pin GPIO_PIN_2
#define SPI2_MISO_MRF_GPIO_Port GPIOC
...
#define SPI2_SCK_MRF_Pin GPIO_PIN_10
#define SPI2_SCK_MRF_GPIO_Port GPIOB
