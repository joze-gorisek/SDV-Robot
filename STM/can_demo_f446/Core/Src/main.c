...
//          }
  ...
  /* USER CODE BEGIN WHILE */
          ...
          for(int i = 0; i < 4; i++)
          {
              set_limit_speed(10.0f, motorIDs[i], 0.0f, V_MAX);
              set_limit_current(5.0f, motorIDs[i], 0.0f, I_MAX);
...
//	  stop_motor(motorIDs[0]);
//	  stop_motor(motorIDs[1]);
//	  stop_motor(motorIDs[2]);
//	  stop_motor(motorIDs[3]);
